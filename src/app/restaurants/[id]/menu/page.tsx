...
<p className="mt-3 text-gray-600 text-sm">{restaurant.description}</p>
  ...
  <div className="w-auto max-w-[220px] p-3 rounded-lg border border-gray-200 shadow-sm bg-white z-20">
    ...
    <div className="text-sm text-gray-700">
      <strong>Opening Hours:</strong> {openingHours.start} to {openingHours.end}
      <span className={`ml-2 text-sm font-semibold ${status === "Closed" ? "text-red-500" : "text-green-600"}`}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 modal-animation ">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl p-6 flex flex-col md:flex-row relative">
            ...
            <div className="w-full md:w-1/2 flex flex-col space-y-3">
              ...
              <p className="text-lg font-semibold text-gray-700">${Number(selectedItem.price).toFixed(2)}</p>
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
              ...
              <h2 className="text-xs text-gray-800">{selectedItem.description}</h2>
